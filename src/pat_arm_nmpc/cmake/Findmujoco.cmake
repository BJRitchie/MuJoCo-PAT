...
# The release tarball extracts to a versioned subdir (e.g. mujoco-3.7.0/), so
# MUJOCO_DIR may point either at that dir directly or at its parent (as
# setup.sh does). Glob the versioned subdirs in as extra hints.
file(GLOB _mujoco_versioned_dirs
    "$ENV{MUJOCO_DIR}/mujoco-*"
    "${MUJOCO_DIR}/mujoco-*"
)

find_path(MUJOCO_INCLUDE_DIR
    NAMES mujoco/mujoco.h
    HINTS "$ENV{MUJOCO_DIR}" "${MUJOCO_DIR}" ${_mujoco_versioned_dirs}
